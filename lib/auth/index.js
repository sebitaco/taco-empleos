...
const SESSION_COOKIE_BASE_NAME = 'session-token'
const SESSION_COOKIE_NAME = getSecureCookieName(SESSION_COOKIE_BASE_NAME, COOKIE_SECURITY_LEVELS.HIGHEST)
...
export async function createSession(user) {
  ...
  // Get secure cookie configuration for session tokens
...
export async function refreshSession() {
  ...
  // Use the same enhanced security configuration for session refresh
  const cookieOptions = getSecureCookieConfig(
    SESSION_COOKIE_NAME,
    COOKIE_SECURITY_LEVELS.HIGHEST,
    { 
